...
export function DraggableBlockPlugin({ anchorElem }: { anchorElem: HTMLElement | null }): JSX.Element | null {
  ...
  return (
    <DraggableBlockPlugin_EXPERIMENTAL
      ...
      targetLineComponent={<div ref={targetLineRef} className="bg-secondary-foreground pointer-events-none absolute top-0 left-0 h-1 opacity-0 will-change-transform" />}
      isOnMenu={isOnMenu}
    />
  )
}
