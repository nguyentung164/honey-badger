...
export function FontSizeToolbarPlugin() {
  ...
  return (
    <ButtonGroup>
      <Button variant="outline" size="icon-sm" className="!size-8" onClick={() => updateFontSize(fontSize - 1)} disabled={fontSize <= MIN_FONT_SIZE}>
      ...
      <Input
        ...
        max={MAX_FONT_SIZE}
      />
      <Button variant="outline" size="icon-sm" className="!size-8" onClick={() => updateFontSize(fontSize + 1)} disabled={fontSize >= MAX_FONT_SIZE}>
