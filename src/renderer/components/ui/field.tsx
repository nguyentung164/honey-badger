...
const fieldVariants = cva('group/field flex w-full min-w-0 flex-col gap-1 data-[invalid=true]:text-destructive', {
  variants: {
    orientation: {
      vertical: '',
...
function FieldLabel({ className, ...props }: React.ComponentProps<typeof Label>) {
  return <Label data-slot="field-label" className={cn('text-xs font-normal leading-none text-muted-foreground', className)} {...props} />
}
