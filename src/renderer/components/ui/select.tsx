  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[disabled]:hover:border-input data-[disabled]:hover:bg-transparent data-[disabled]:dark:hover:bg-input/30 data-[disabled]:focus-visible:border-input data-[disabled]:focus-visible:ring-0',
        className
      )}
      {...props}
    >
