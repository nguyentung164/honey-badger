...
const compactContentClass =
  'ContentEditable__root relative block min-h-[12rem] max-h-[min(40vh,22rem)] min-w-0 flex-1 overflow-auto px-3 py-3 text-sm focus:outline-none'
