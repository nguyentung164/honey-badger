  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="z-[100] flex max-h-[min(90vh,36rem)] max-w-2xl flex-col gap-3 overflow-hidden p-4 sm:max-w-2xl"
      >
        <DialogHeader className="flex shrink-0 flex-row flex-wrap items-center gap-2 space-y-0 p-0 text-left sm:text-left">
          <DialogTitle className="min-w-0 flex-1 basis-[min(100%,10rem)] text-lg font-semibold leading-tight sm:basis-auto">
            {t('taskManagement.changeHistoryTitle')}
          </DialogTitle>
          <DialogClose asChild>
