...
export const GitConflictDiffView = forwardRef<CodeDiffViewerHandle, GitConflictDiffViewProps>(function GitConflictDiffView(
  ...
  const { resolvingFile, isSaving, resolveFile, loadFileContent, saveAndStage } = useGitConflictFileActions(repoCwd, () => void afterFileResolved())
  ...
  const readyToContinue = files.length === 0 && conflictType !== undefined && (conflictType === 'rebase' || conflictType === 'cherry-pick')
