  ...
  return (
    ...
    >
      <div className="flex items-center h-full min-w-0">
        ...
        <div className="flex items-center h-full min-w-0 overflow-x-auto" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties}>
          <Tooltip>
          ...
          {onPrevChange && onNextChange && (
            <>
              ...
              {changePosition && changePosition.total > 0 && (
                <span className="min-w-[2.75rem] text-center text-[10px] tabular-nums text-muted-foreground shrink-0">
                  {changePosition.current}/{changePosition.total}
                </span>
              )}
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            className="font-medium text-xs max-w-[40%] truncate cursor-pointer"
