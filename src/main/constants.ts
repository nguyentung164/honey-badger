...
export const IPC = {
  ...
  WINDOW: {
    ...
    SHOW_LOG_CLOSE: 'window:show-log-close',
    SHOW_LOG_DOCK_REQUEST: 'window:show-log-dock-request',
    SHOW_LOG_SYNC_HANDOFF: 'window:show-log-sync-handoff',
    ...
    DEV_PIPELINES_DOCK_REQUEST: 'window:dev-pipelines-dock-request',
  },
  ...
  GIT: {
    ...
    /** Chỉ cập nhật remote-tracking ref refs/remotes/<remote>/<branch>. */
    FETCH_REMOTE_BRANCH: 'git:fetch-remote-branch',
  ...
  SYSTEM: {
    ...
    CREATE_DIR: 'system:create-dir',
    DELETE_PATH: 'system:delete-path',
    RENAME_PATH: 'system:rename-path',
    COPY_PATH: 'system:copy-path',
  ...
  LSP: {
    ...
    STOP: 'lsp:stop',
    SEND: 'lsp:send',
    STREAM_MESSAGE: 'lsp:stream:message',
    STREAM_STATE: 'lsp:stream:state',
  },
  TERMINAL: {
    ...
    GET_USER_HOME: 'terminal:get-user-home',
    STREAM_DATA: 'terminal:stream:data',
    STREAM_EXIT: 'terminal:stream:exit',
  },
  UPDATER: {
  ...
  AUTOMATION: {
    ...
    PROJECT_LIST_FOR_TASK: 'automation:project:list-for-task',
    PROJECT_LIST_TASK_LINKS: 'automation:project:list-task-links',
    PROJECT_LINK_TASK: 'automation:project:link-task',
    PROJECT_UNLINK_TASK: 'automation:project:unlink-task',
  ...
  COMMIT_WORKFLOW: {
    START: 'commit-workflow:start',
    CANCEL: 'commit-workflow:cancel',
    GET_ACTIVE: 'commit-workflow:get-active',
    LIST_RUNS: 'commit-workflow:list-runs',
    GET_RUN: 'commit-workflow:get-run',
    SYNC_FLUSH: 'commit-workflow:sync-flush',
    GET_SYNC_STATUS: 'commit-workflow:get-sync-status',
    GET_ACTIVE_FOR_PROJECT: 'commit-workflow:get-active-for-project',
    STREAM_RUN: 'commit-workflow:stream-run',
  },
}
